...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'features.subtitle': 'Все, что нужно для создания потрясающих 360° впечатлений',
  ...
  en: {
    ...
    'features.subtitle': 'Everything you need to create stunning 360° experiences',
  ...
  es: {
    ...
    'features.subtitle': 'Todo lo que necesitas para crear experiencias 360° impresionantes',
